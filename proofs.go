...
func ProveCapellaExecutionPayloadAgainstBlockHeader(
	blockHeader *phase0.BeaconBlockHeader,
	...
	// proof execution payload against the block body
	executionPayloadAgainstBlockHeaderProof, executionPayloadRoot, err := ProveCapellaExecutionPayloadAgainstBlockBody(withdrawalBeaconBlockBody)
	if err != nil {
		return nil, [32]byte{}, err
	}
...
func ProveCapellaWithdrawalAgainstExecutionPayload(
	executionPayload *capella.ExecutionPayload,
	withdrawalIndex uint8,
) ([][32]byte, error) {
	// prove withdrawal list against the execution payload
	withdrawalListAgainstExecutionPayloadProof, err := ProveCapellaWithdrawalListAgainstExecutionPayload(executionPayload)
	if err != nil {
		return nil, err
	}
...
func ProveCapellaWithdrawalListAgainstExecutionPayload(executionPayloadFields *capella.ExecutionPayload) (Proof, error) {
	executionPayloadFieldRoots, err := GetCapellaExecutionPayloadFieldRoots(executionPayloadFields)

	if err != nil {
		return nil, err
	}

	return GetProof(executionPayloadFieldRoots, withdrawalsIndex, executionPayloadMerkleSubtreeNumLayersCapella)
}
...
func ProveTimestampAgainstCapellaExecutionPayload(executionPayloadFields *capella.ExecutionPayload) (Proof, error) {
	...
	return GetProof(executionPayloadFieldRoots, timestampIndex, executionPayloadMerkleSubtreeNumLayersCapella)
}
...
// Refer to beaconblockbody.go in go-eth2-client
// https://github.com/attestantio/go-eth2-client/blob/654ac05b4c534d96562329f988655e49e5743ff5/spec/bellatrix/beaconblockbody_encoding.go
func ProveCapellaExecutionPayloadAgainstBlockBody(beaconBlockBody *capella.BeaconBlockBody) (Proof, [32]byte, error) {
...
func GetCapellaExecutionPayloadFieldRoots(executionPayloadFields *capella.ExecutionPayload) ([]phase0.Root, error) {
