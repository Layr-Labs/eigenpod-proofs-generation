...
func ProveWithdrawalListAgainstExecutionPayload(executionPayloadFieldRoots []phase0.Root) (Proof, error) {
	return GetProof(executionPayloadFieldRoots, withdrawalsIndex, CeilLog2(len(executionPayloadFieldRoots)))
}
...
func ProveTimestampAgainstExecutionPayload(executionPayloadFieldRoots []phase0.Root) (Proof, error) {
	return GetProof(executionPayloadFieldRoots, timestampIndex, CeilLog2(len(executionPayloadFieldRoots)))
}
